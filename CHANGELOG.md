...
- **Query execution time** (#50): the last submitted query's duration (success or failure) renders in the query editor's top-left corner -- `Nms` under a second, `N.NNs` at or above. Cleared on switching the active file.
